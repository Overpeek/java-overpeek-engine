...
public class Texture {
    ...
    public void bindCompute() {
		GL43.glBindImageTexture(0, getId(), 0, false, 0, GL15.GL_WRITE_ONLY, GL30.GL_RGBA32F);
    }
    
    public static void unbindCompute() {
		GL43.glBindImageTexture(0, 0, 0, false, 0, GL15.GL_WRITE_ONLY, GL30.GL_RGBA32F);
    }
